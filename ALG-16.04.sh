#!/bin/bash
# BitalGO Masternode Setup Script V1.0 for Ubuntu 16.04 LTS
#
...
wget https://github.com/BitalgoCOIN/BitalGO/releases/download/v1.0/BitalGO-daemon-ubuntu-16.04.tar.gz
tar -xzvf BitalGO-daemon-ubuntu-16.04.tar.gz
